...
const BackHomeBtn = () => {
    return location.pathname !== '/' && location.pathname !== '/my-posts' && (
        <Link to="/">
            <button aria-label="Blog home" data-title="Blog home" 
            title="back to blog" className="blog-back-to-home-button tooltip-handle flex flex-row items-center rounded-full p-3 transition duration-100 ease-in-out hover:bg-black/10">
